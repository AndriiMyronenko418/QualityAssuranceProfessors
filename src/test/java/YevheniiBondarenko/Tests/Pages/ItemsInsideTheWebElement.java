...
public class ItemsInsideTheWebElement extends BasePage {
    ...
    public WebElement chooseLocationBtn(){return $(CHOOSE_LOCATION_BTN);}
    public WebElement changeLanguageBtn(){return $(CHANGE_LANGUAGE_BTN);}
    public WebElement searchCityBtn(){return $(SEARCH_OPEN);}
    public WebElement searchField(){return $(SEARCH_FIELD);}
    public WebElement brovaryKyivRegion(){return $(BROVARY_CITY);}
    public WebElement onAMap(){return $(ON_A_MAP);}
    public WebElement epiOnAMap(){return $(BROVARY_EPICENTR);}
    public WebElement choose(){return $(CHOOSE);}
    public WebElement cityNameInHeader(){return $(CITY_IN_HEADER);}
}