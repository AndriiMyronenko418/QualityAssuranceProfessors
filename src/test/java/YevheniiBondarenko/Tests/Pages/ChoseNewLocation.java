...
public class ChoseNewLocation extends BasePage {
    ...
    public WebElement catalogOfProduct() {
        return $(CATALOG_OF_PRODUCT);
    }

    public WebElement householdAppliance() {
        return $(HOUSEHOLD_APPLIANCE);
    }

    public List<WebElement> listOfProduct1() {
        return $$(LIST_OF_PRODUCT_1);
    }

    public WebElement aeroGrill() {
        return $(AERO_GRILL);
    }

    public WebElement myChooiseItem() {
        return $(MY_ITEM);
    }
    ...
    public WebElement blueBuyButton() {
        return $(BLUE_BUY_BUTTON);
    }
