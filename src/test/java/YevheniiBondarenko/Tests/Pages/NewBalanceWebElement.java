...
public class NewBalanceWebElement extends BasePage {
    ...
    public WebElement shoesForCityRoad() {
        return $(FOR_CITY_ROAD);
    }

    public WebElement myChoice() {
        return $(MY_CHOICE);
    }

    public WebElement sizeBeforeCart() {
        return $(SIZE_BEFORE_CART);
    }
    ...
    public WebElement itemInsideTheCartVisible() {
        return $(ITEM_INSIDE_CART);
    }
    ...
    public List<WebElement> kindOfShoes() {
