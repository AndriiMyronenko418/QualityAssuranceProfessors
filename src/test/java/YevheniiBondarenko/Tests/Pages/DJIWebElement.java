...
public class DJIWebElement extends BasePage {
    public DJIWebElement(WebDriver driver) {
        super(driver);
    }
    ...
    public List<WebElement> mainProductMenu(){return $$(MAIN_PRODUCT_MENU);}
    public WebElement action2(){return $(ACTION_2);}
    public List<WebElement> action2Items(){return $$(ACTION_2_ITEMS);}
    public WebElement buyBtn(){return $(BUY_BTN);}
    public WebElement closedPopUp(){return $(CLOSED_POP_UP);}
    public WebElement cardItemNumber(){return $(CART_ITEMS_NUMBER);}
    public WebElement enter(){return $(ENTER);}
    public WebElement inputEmail(){return $(INPUT_EMAIL);}
    public WebElement inputPassword(){return $(INPUT_PASSWORD);}
    public List<WebElement> enterBtn(){return $$(ENTER_BTN);}
    public WebElement userName(){return $(USER_NAME);}
    public WebElement exitUserAccount(){return $(EXIT_USER_ACCOUNT);}
}