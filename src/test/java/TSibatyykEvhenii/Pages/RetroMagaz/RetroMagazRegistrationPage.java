package TSibatyykEvhenii.Pages.RetroMagaz;
...
public class RetroMagazRegistrationPage extends BasePage {
    ...
    public List<WebElement> setNameRegistration() {
        return $$(INPUT_FIELD_NAME);
    }

    public List<WebElement> setSurnameRegistration() {
        return $$(INPUT_FIELD_SURENAME);
    }

    public List<WebElement> setTelNumberRegistration() {
        return $$(INPUT_FIELD_TEL_NUMBER);
    }

    public List<WebElement> setEmailRegistration() {
        return $$(INPUT_FIELD_EMAIL);
    }

    public List<WebElement> setPasRegistration() {
        return $$(INPUT_FIELD_PASS);
    }

    public List<WebElement> getAgreeCheckbox() {
