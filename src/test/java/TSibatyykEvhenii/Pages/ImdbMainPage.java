...
public class ImdbMainPage extends BasePage {
    public ImdbMainPage(WebDriver driver) {super(driver);    }
    ...
    public void goToImdb(){ driver.get("https://www.imdb.com/");   }

    public WebElement getSearchField(){return $(HEADER_SEARCH);}

    public List<WebElement> getJawsFromSearch(){return $$(SEARCH_REAZULT);}

    public List<WebElement> getDirectorName(){return $$(DIRECTOR_STRING);}
}
