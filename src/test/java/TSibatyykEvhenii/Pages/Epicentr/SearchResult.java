...
public class SearchResult extends BasePage {
    ...
    private static final String CABEL_LIST_AFTER_SEARCH = "//div[contains(@class,'swiper-slide')]/div";
    ...
    public List<WebElement> chooseComputerCabel(){
        return $$(CABEL_LIST_AFTER_SEARCH);
    }
    ...
    public void moveToFirstElementCabel(){
